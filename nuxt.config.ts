...
export default defineNuxtConfig({
  app: {
    head: {
      title: "Supporting Gender Equality Outcomes in Development Research",
      meta: [
        { name: "description", content: "Reflections on a Multi-year Collaboration between Gender at Work, IDRC and its Partners" },
        { name: "viewport", content: "width=device-width, initial-scale=1" },
        {
          hid:"og:title",
          name:"og:title",
          content: 'Supporting Gender Equality Outcomes in Development Research'
        },
        {
          hid:"og:description",
          name:"og:description",
          content: 'Reflections on a Multi-year Collaboration between Gender at Work, IDRC and its Partners'
        },
        {
            hid:"og:site_name",
          name:"og:site_name",
          content: 'Gender Report'
        },
        {
            hid:"og:image",
          name:"og:image",
